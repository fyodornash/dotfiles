...
if [ -f '/home/michael/google-cloud-sdk/path.bash.inc' ]; then source '/home/michael/google-cloud-sdk/path.bash.inc'; fi
...
# export PATH="/home/michael/anaconda2/bin:$PATH"
